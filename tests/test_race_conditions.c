...
static int poll_attrs_then_die(xcb_connection_t *c, unsigned int request,
...
static void test_destroy_during_manage_no_crash(void) {
  ...
  g_attr_entries[g_attr_entries_len++] =
      (attr_reply_entry_t){win, false, XCB_MAP_STATE_VIEWABLE};
