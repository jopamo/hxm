...
__real_xcb_get_extension_data(xcb_connection_t *c, xcb_extension_t *ext);
const xcb_query_extension_reply_t *
__wrap_xcb_get_extension_data(xcb_connection_t *c, xcb_extension_t *ext) {
...
__wrap_xcb_damage_query_version_reply(xcb_connection_t *c,
...
__wrap_xcb_randr_query_version_reply(xcb_connection_t *c,
...
__real_xcb_get_property_reply(xcb_connection_t *c,
                              xcb_get_property_cookie_t cookie,
                              xcb_generic_error_t **e);

xcb_get_property_reply_t *
__wrap_xcb_get_property_reply(xcb_connection_t *c,
                              xcb_get_property_cookie_t cookie,
                              xcb_generic_error_t **e) {
...
xcb_damage_query_version(xcb_connection_t *c, uint32_t major, uint32_t minor) {
  (void)c;
  (void)major;
  (void)minor;
