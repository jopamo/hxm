...
static xcb_get_property_reply_t *make_atom_reply(const xcb_atom_t *atoms_list,
                                                 uint32_t count) {
...
static void test_wm_icon_name_fallback(void) {
  ...
  xcb_get_property_reply_t *rep =
      make_string_reply(atoms.UTF8_STRING, "icon-net", 8);
...
static void test_wm_command_first_token(void) {
  ...
  xcb_get_property_reply_t *rep =
      make_string_reply(XCB_ATOM_STRING, payload, (int)sizeof(payload));
...
static void test_property_deletions_reset_defaults(void) {
  ...
  xcb_get_property_reply_t *proto_reply =
      make_atom_reply(proto_atoms.atoms_list, 2);
