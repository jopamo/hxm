...
static void mock_handler(server_t *s, const cookie_slot_t *slot, void *reply,
...
void test_stale_reply_dropped(void) {
  ...
  cookie_slot_t stale_slot = {.sequence = 1,
                              .type = COOKIE_GET_PROPERTY,
                              .client = h,
                              .txn_id = 5,
  ...
  cookie_slot_t fresh_slot = {.sequence = 2,
                              .type = COOKIE_GET_PROPERTY,
                              .client = h,
                              .txn_id = 15,
                              .handler = mock_handler,
