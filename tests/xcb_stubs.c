...
int (*stub_poll_for_reply_hook)(xcb_connection_t* c, unsigned int request, void** reply, xcb_generic_error_t** error) = NULL;
...
xcb_void_cookie_t xcb_create_window_checked(xcb_connection_t* c,
                                            ...
                                            uint32_t value_mask,
                                            const void* value_list) {
  return xcb_create_window(c, depth, wid, parent, x, y, width, height, border_width, _class, visual, value_mask, value_list);
}
...
int stub_config_calls_count(void) {
  return stub_config_calls_len;
}
...
xcb_get_property_cookie_t xcb_get_property(xcb_connection_t* c, uint8_t _delete, xcb_window_t window, xcb_atom_t property, xcb_atom_t type, uint32_t long_offset, uint32_t long_len) {
  (void)c;
  (void)_delete;
  (void)window;
  (void)property;
...
size_t xcb_stubs_queued_event_len(void) {
  return stub_queued_len;
}

size_t xcb_stubs_event_len(void) {
  return stub_event_len;
}
