...
void test_wm_icon(void) {
  ...
  // byte order. On Little Endian: BGRA in memory. 0xFF0000FF in u32 is ...
  // Let's just check the u32 value matches, assuming no endian swap in copy
  // logic (which I verified).
