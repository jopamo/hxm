 ...
 */
bool render_context_ensure(xcb_connection_t *conn, xcb_window_t win,
                           xcb_visualtype_t *visual, render_context_t *ctx,
...
void render_frame(xcb_connection_t *conn, xcb_window_t win,
                  ...
                  bool is_test, const char *title, bool active, int width,
                  int height, theme_t *theme, cairo_surface_t *icon,
